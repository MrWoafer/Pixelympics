...
public class TripleJumpRaceController : MonoBehaviour
{
    [Header("References")]
    ...
    void Start()
    {
        ...
        Debug.Log("The current record is: " + PlayerPrefs.GetFloat("Triple Jump Record", 9f).ToString() + " m");
        Debug.Log("The current worst record is: " + PlayerPrefs.GetFloat("Triple Jump Worst Record", 1f).ToString() + " m");
        ...
        SetRecordDistance(PlayerPrefs.GetFloat("Triple Jump Record", 9f));
    }
