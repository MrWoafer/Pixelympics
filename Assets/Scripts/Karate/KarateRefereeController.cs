...
public class KarateRefereeController : MonoBehaviour
{
    [Header("Settings")]
    ...
    private KaratePlayerController player1;
    public GameObject player2Obj;
    private KaratePlayerController player2;
    ...
    void Start()
    {
        ...
        player1 = player1Obj.GetComponent<KaratePlayerController>();
        player2 = player2Obj.GetComponent<KaratePlayerController>();
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                if (PlayerHasWon() && !winnerDeclared)
                {
                    winnerDeclared = true;
                    ...
                    BroadcastScore(player1.GetRoundWins(), player1.playerID);
                    BroadcastScore(player2.GetRoundWins(), player2.playerID);
                }
